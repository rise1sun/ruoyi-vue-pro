...
import cn.iocoder.yudao.module.wms.common.enums.CommonErrorEnum;
import cn.iocoder.yudao.module.wms.common.enums.ErrorEnum;
import cn.iocoder.yudao.module.wms.common.exception.BusinessErrorEnum;
import cn.iocoder.yudao.module.wms.common.exception.BusinessException;
...
import static cn.iocoder.yudao.module.wms.enums.ErrorCodeConstants.TRAY_ABSENT_ERROR;
...
//    }
    ...
    public static void isNull(Object obj, ErrorCode errorCode,Object... args) {
        if (Objects.nonNull(obj)) {
    ...
    //如果不是非空对象，则抛异常
    public static void isNotEmpty(Object obj, ErrorCode errorCode, Object... args) {
        if (isEmpty(obj)) {
            throw exception(errorCode, args);
        }
    }
    ...
    //如果不是非空对象，则抛异常
    public static void isEmpty(Object obj, ErrorCode errorCode, Object... args) {
        if (!isEmpty(obj)) {
            throw exception(errorCode, args);
        }
    }

    public static void equal(Object o1, Object o2,ErrorCode errorCode, String msg) {
        if (!ObjectUtil.equal(o1, o2)) {
            throw exception(errorCode, msg);
        }
    }

    public static void equal(Object o1, Object o2,ErrorCode errorCode) {
        if (!ObjectUtil.equal(o1, o2)) {
            throw exception(errorCode);
        }
    }

    public static void notEqual(Object o1, Object o2,ErrorCode errorCode, String msg) {
        if (ObjectUtil.equal(o1, o2)) {
            throw exception(errorCode, msg);
        }
    }
    public static void notEqual(Object o1, Object o2,ErrorCode errorCode) {
        if (ObjectUtil.equal(o1, o2)) {
            throw exception(errorCode);
        }
    }
